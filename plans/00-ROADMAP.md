...
| **03** | `03-SOURCE-INGESTION-SAFETY.md` | next | 02 green | Universal source intake, untrusted web/pdf fencing (`<untrusted_source>`), path sandboxing, SHA-256 hash deduplication. |
