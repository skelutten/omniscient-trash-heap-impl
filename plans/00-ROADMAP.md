...
|---:|---|---|---|---|
| **01** | `01-REPOSITORY-FOUNDATION.md` | next | none | Installable package, minimal YAML registry loader, CLI entry point. |
| **02** | `02-DETERMINISTIC-CORE.md` | blocked by 01 | 01 green | Canonical frontmatter parser, linter (`E001`–`E099`), Agent Skills emitter (`SKILL.md`), atomic rename. |
| **03** | `03-SOURCE-INGESTION-SAFETY.md` | blocked by 02 | 02 green | Universal source intake, untrusted web/pdf fencing (`<untrusted_source>`), path sandboxing, SHA-256 hash deduplication. |
| **04** | `04-PROPOSAL-PROMOTION-RECOVERY.md` | blocked by 03 | 03 green | Candidate proposal extraction, human review approval contract, deterministic atomic promotion (`.tmp` + `os.replace`). |
