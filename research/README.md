...
| `cacheblend-synthetic-gravity-and-deepseek-harness.md` | Systems RAG serving, synthetic gravity & agent harness review (P22) | CacheBlend (arXiv:2405.16444, non-prefix KV-cache reuse & selective cross-attention), UChicago AI+Sys seminar (Sanjay Krishnan on scaffolding cancer & long-tail devil), Hayanan on synthetic gravity wells & model collapse, and DeepSeek Harness (dsh/Cordis plugin architecture, verifiable step-loop); `ARCHITECTURE.md`, `RETRIEVAL.md`, `AGENT-SKILLS.md`, `VALIDATION.md`, `REVIEW-PROMOTION.md` |
